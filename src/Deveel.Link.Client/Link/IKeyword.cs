...
namespace Deveel.Link
{
    ...
    public partial interface IKeyword
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<ErrorResponse,KeywordCreateHeaders>> CreateWithHttpMessagesAsync(Route body, string number, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse<ErrorResponse>> UpdateWithHttpMessagesAsync(string number, string platformId, string partnerId, string id, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// </summary>
        /// <remarks>
        /// Gets a list of keywords that are mapped within a certain number and
        /// that has a certain platformId and a certain partnerId
        /// </remarks>
        /// <param name='number'>
        /// The number that the keywords are routed to
        /// </param>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse<object>> GetAllWithHttpMessagesAsync(string number, string platformId, string partnerId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
