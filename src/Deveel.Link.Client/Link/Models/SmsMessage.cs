...
namespace Deveel.Link.Models
{
    ...
    public partial class SmsMessage
    {
        ...
        /// 'SHORTNUMBER', 'MSISDN'</param>
        /// <param name="destinationTON">This is the destination type of
        /// number. Possible values include: 'MSISDN', 'SHORTNUMBER'</param>
        /// <param name="dcs">This is the Data Coding Scheme that should be
        /// used when sending the SMS. Possible values include: 'GSM',
        /// 'BINARY', 'UCS2', 'TEXT'</param>
        ...
        public SmsMessage(string source, string destination, string platformId, string platformPartnerId, string sourceTON = default(string), string destinationTON = default(string), string dcs = default(string), string userDataHeader = default(string), string userData = default(string), bool? useDeliveryReport = default(bool?), IList<string> deliveryReportGates = default(IList<string>), int? relativeValidityTime = default(int?), System.DateTime? absoluteValidityTime = default(System.DateTime?), string refId = default(string), bool? ignoreResponse = default(bool?), object customParameters = default(object))
        {
            Source = source;
            SourceTON = sourceTON;
        ...
        /// values below. Possible values include: 'ALPHANUMERIC',
        /// 'SHORTNUMBER', 'MSISDN'
        /// </summary>
        ...
        /// values include: 'MSISDN', 'SHORTNUMBER'
        /// </summary>
        ...
        /// when sending the SMS. Possible values include: 'GSM', 'BINARY',
        /// 'UCS2', 'TEXT'
        /// </summary>
